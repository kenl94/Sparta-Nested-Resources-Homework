...
class SuperherosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create superhero" do
    assert_difference('Superhero.count') do
      post superheros_url, params: { superhero: { age: @superhero.age, name: @superhero.name, state: @superhero.state } }
    end
  ...
  test "should update superhero" do
    patch superhero_url(@superhero), params: { superhero: { age: @superhero.age, name: @superhero.name, state: @superhero.state } }
