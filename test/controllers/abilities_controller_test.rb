...
class AbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post abilities_url, params: { ability: { power: @ability.power, superhero_id: @ability.superhero_id } }
    end
  ...
  test "should update ability" do
    patch ability_url(@ability), params: { ability: { power: @ability.power, superhero_id: @ability.superhero_id } }
